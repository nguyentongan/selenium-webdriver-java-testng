...
public class Topic_04_Xpath_Css {
	...
	public void TC_02_Login_Invalid_Email() {
		...
		driver.findElement(By.id("email")).sendKeys("123@234.333");
	...
	public void TC_04_Login_Incorrect_Email() {
		driver.navigate().refresh();
		driver.findElement(By.id("email")).sendKeys("automation369852@gmail.com");
		driver.findElement(By.name("login[password]")).sendKeys("123369853");
		driver.findElement(By.xpath("//button[@title='Login']")).click();
